                ...
                <form id="blog_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active show" role="tabpanel">
                            <div class="ibox">
                                {{-- <div class="ibox-title"><h5>Article Details</h5></div> --}}
                                <div class="ibox-content">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="post_url" name="post_url" />
                                                        <span class="text-muted">
                                                            Post URL: https://buyahouseinrosarito.com<span id="slug_preview"></span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category" class="select2_dropdown select22_dropdown form-control">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <strong class="form-label" for="parent_id">Parent Article:</strong>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="preview-area" id="previewArea">
                                                    ...
                                                    <div class="action-buttons">
                                                        <a href="" target="_blank" class="btn btn-secondary btn-sm" id="viewButton"><i class="fa fa-eye"></i></a>
                                                        <button type="button" class="btn text-danger btn-sm" id="deleteButton"><i class="fa fa-trash"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 order-lg-2 order-3">
                                            <div class="form-group">
                                                <strong class="d-flex align-items-center">
                                                    <input type="checkbox" class="i-checks" id="btn_status" name="status">
                                        ...
                                        <div class="col-md-12 order-lg-2 order-3">
                                            <div class="form-group">
                                                <strong class="d-flex align-items-center">
                                                    <input type="checkbox" class="i-checks" id="disable_crawl" name="disable_crawl">
                                                    <label class="mx-3 mt-2" for="disable_crawl">Disable Crawl</label>
                                                </strong>
                                            </div>
                                        </div>
