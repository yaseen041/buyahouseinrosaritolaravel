                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" id="title-content" placeholder="e.g. Downtown Los Angeles" value="{{$neighborhood->title}}" required class="form-control">
                                                        <input type="text" name="slug" value="{{$neighborhood->slug}}" id="slug" hidden>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="zip" required class="form-control" value="{{$neighborhood->zip}}" placeholder="e.g. 90012">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="latitude" id="latitude" value="{{$neighborhood->latitude}}" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <strong class="form-label" for="longitude">Longitude:</strong>
                                                        <input type="text" name="longitude" id="longitude" value="{{$neighborhood->longitude}}" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 order-lg-2 order-3">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" id="description">{{ $neighborhood->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="meta_title" type="text" name="meta_title" value="{{ $neighborhood->meta_title}}" />
                                            </div>
                                            <div class="form-group">
                                                <strong class="form-label" for="meta_keywords">Meta keywords:</strong>
                                                <input class="form-control" id="meta_keywords" type="text" name="meta_keywords" value="{{ $neighborhood->meta_keywords}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="meta_description" name="meta_description" rows="10">{{ $neighborhood->meta_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="{{ asset('uploads/neighborhoods') }}/{{$neighborhood->fb_image}}" target="_blank">
                                                <img src="{{ asset('uploads/neighborhoods') }}/{{$neighborhood->fb_image}}" class="rounded-circle" style="width: 65px; height: 65px;">
                                            </a>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <strong class="form-label" for="facebook_meta_title">Facebook Page Title:</strong>
                                                <input class="form-control" id="facebook_meta_title" type="text" name="facebook_meta_title" value="{{ $neighborhood->fb_title}}" />
                                            </div>
                                            <div class="form-group">
                                                <strong class="form-label" for="facebook_meta_description">Description:</strong>
                                                <textarea class="form-control" id="facebook_meta_description" name="facebook_meta_description" rows="10">{{ $neighborhood->fb_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="{{ asset('uploads/neighborhoods') }}/{{$neighborhood->twitter_image}}" target="_blank">
                                                <img src="{{ asset('uploads/neighborhoods') }}/{{$neighborhood->twitter_image}}" class="rounded-circle" style="width: 65px; height: 65px;">
                                            </a>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <strong class="form-label" for="twitter_meta_title">Twitter Page Title:</strong>
                                                <input class="form-control" id="twitter_meta_title" type="text" name="twitter_meta_title" value="{{ $neighborhood->twitter_title}}" />
                                            </div>
                                            <div class="form-group">
                                                <strong class="form-label" for="twitter_meta_description">Description:</strong>
                                                <textarea class="form-control" id="twitter_meta_description" name="twitter_meta_description" rows="10">{{ $neighborhood->twitter_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control mt-2" id="json_ld_code" name="json_ld_code" rows="30">{{ $neighborhood->json_ld_code}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    async function initMap() {
        ...
        let infoWindow = new google.maps.InfoWindow({
            content: "Latitude: " + myLatlng.lat + "<br>Longitude: " + myLatlng.lng + "<br>Click on the map to select coordinates",
            position: myLatlng,
        });
        infoWindow.open(map);
...
<script>
    ...
    $(document).ready(function() {
        $(document).on("click", "#btn_create", function() {
            ...
            $.ajax({
                url: "{{ url('admin/communities/update') }}",
                type: 'POST',
                data: formData,
                dataType: 'json',
                cache: false,
