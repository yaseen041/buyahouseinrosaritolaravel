                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" id="title-content" value="{{$property->title}}" placeholder="e.g. Suite 301 – Tower 4" required class="form-control">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="GLA" id="GLA" required class="form-control money" value="{{$property->GLA}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row ">
