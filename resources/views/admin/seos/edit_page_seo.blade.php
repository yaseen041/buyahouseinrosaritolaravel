    ...
    <div class="col-lg-8 col-sm-8 col-xs-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong> Edit Page SEO: </strong><strong> {{ $page_seo->page_name }} </strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-4 col-sm-4 col-xs-4 text-right">
        <a class="btn btn-primary text-white t_m_25" href="{{ url('admin/seo')}}">
            <i class="fa fa-arrow-left" aria-hidden="true"></i> Back to SEO
        </a>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form id="edit_form" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $page_seo->id }}">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="page_name" type="text" name="page_name" value="{{ $page_seo->page_name}}" />
                        </div>
                        <div class="form-group">
                            <strong class="form-label" for="meta_title">Meta Title:</strong>
                            <input class="form-control" id="meta_title" type="text" name="meta_title" value="{{ $page_seo->meta_title}}" />
                        </div>
                        <div class="form-group">
                            <strong class="form-label" for="meta_keywords">Meta keywords:</strong>
                            <input class="form-control" id="meta_keywords" type="text" name="meta_keywords" value="{{ $page_seo->meta_keywords}}" />
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="meta_description" name="meta_description" rows="5">{{ $page_seo->meta_description}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <a href="{{ asset('assets/images') }}/{{$page_seo->fb_image}}" target="_blank">
                                        <img src="{{ asset('assets/images') }}/{{$page_seo->fb_image}}" class="rounded-circle" style="width: 65px; height: 65px;">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" id="facebook_meta_title" type="text" name="facebook_meta_title" value="{{ $page_seo->fb_title}}" />
                        </div>
                        <div class="form-group">
                            <strong class="form-label" for="facebook_meta_description">Description:</strong>
                            <textarea class="form-control" id="facebook_meta_description" name="facebook_meta_description" rows="5">{{ $page_seo->fb_description}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <a href="{{ asset('assets/images') }}/{{$page_seo->twitter_image}}" target="_blank">
                                    <img src="{{ asset('assets/images') }}/{{$page_seo->twitter_image}}" class="rounded-circle" style="width: 65px; height: 65px;">
                                </a>
                            </div>
                        </div>
                        <div class="form-group">
                            <strong class="form-label" for="twitter_meta_title">Twitter Page Title:</strong>
                            <input class="form-control" id="twitter_meta_title" type="text" name="twitter_meta_title" value="{{ $page_seo->twitter_title}}" />
                        </div>
                        <div class="form-group">
                            <strong class="form-label" for="twitter_meta_description">Description:</strong>
                            <textarea class="form-control" id="twitter_meta_description" name="twitter_meta_description" rows="5">{{ $page_seo->twitter_description}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="form-group">
                            ...
                            <textarea class="form-control mt-2" id="json_ld_code" name="json_ld_code" rows="30">{{ $page_seo->json_ld_code}}</textarea>
                        </div>
                        <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(status) {
                    if (status.msg == 'success') {
                        ...
                        setTimeout(function() {
                            window.location.href = "{{url('admin/seo')}}";
                        }, 2000);
