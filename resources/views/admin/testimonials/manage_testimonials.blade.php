        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form id="search_form" action="{{url('admin/testimonials')}}" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                        ...
                                        <a class="btn btn-danger ml-4" href="{{ url('admin/testimonials/') }}">
                                            Clear Search
                                        </a>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <p>Showing {{ $testimonials->firstItem() }} to {{ $testimonials->lastItem() }} of {{ $testimonials->total() }} entries</p>
                        </div>
...
<script>
    ...
    $(document).on("click", ".btn_testimonial_edit", function() {
        var id = $(this).attr('data-id');
        $.ajax({
            url: "{{ url('admin/testimonials/show') }}",
            type: 'POST',
            dataType: 'json',
            data: {
                "_token": "{{ csrf_token() }}",
    ...
    $(document).on("click", "#update_testimonial_button", function() {
        ...
        $.ajax({
            url: "{{ url('admin/testimonials/update') }}",
            type: 'POST',
            data: formData,
            dataType: 'json',
            cache: false,
