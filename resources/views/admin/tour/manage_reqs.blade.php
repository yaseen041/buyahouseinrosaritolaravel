        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form id="search_form" action="{{url('admin/tour')}}" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                        ...
                                        <a class="btn btn-danger ml-4" href="{{ url('admin/tour/') }}">
                                            Clear Search
                                        </a>
                                    </span>
                                </div>
