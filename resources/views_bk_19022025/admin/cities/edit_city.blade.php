                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" id="title-content" placeholder="e.g. Rosarito" value="{{$city->name}}" required class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="state" required class="form-control" value="{{$city->state}}" placeholder="e.g. Baja California Norte">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 order-lg-2 order-3">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" id="description">{{$city->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="meta_title" type="text" name="meta_title" value="{{ $city->meta_title}}" />
                                            </div>
                                            <div class="form-group">
                                                <strong class="form-label" for="meta_keywords">Meta keywords:</strong>
                                                <input class="form-control" id="meta_keywords" type="text" name="meta_keywords" value="{{ $city->meta_keywords}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="meta_description" name="meta_description" rows="10">{{ $city->meta_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="{{ asset('uploads/cities') }}/{{$city->fb_image}}" target="_blank">
                                                <img src="{{ asset('uploads/cities') }}/{{$city->fb_image}}" class="rounded-circle" style="width: 65px; height: 65px;">
                                            </a>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <strong class="form-label" for="facebook_meta_title">Facebook Page Title:</strong>
                                                <input class="form-control" id="facebook_meta_title" type="text" name="facebook_meta_title" value="{{ $city->fb_title}}" />
                                            </div>
                                            <div class="form-group">
                                                <strong class="form-label" for="facebook_meta_description">Description:</strong>
                                                <textarea class="form-control" id="facebook_meta_description" name="facebook_meta_description" rows="10">{{ $city->fb_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="{{ asset('uploads/cities') }}/{{$city->twitter_image}}" target="_blank">
                                                <img src="{{ asset('uploads/cities') }}/{{$city->twitter_image}}" class="rounded-circle" style="width: 65px; height: 65px;">
                                            </a>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <strong class="form-label" for="twitter_meta_title">Twitter Page Title:</strong>
                                                <input class="form-control" id="twitter_meta_title" type="text" name="twitter_meta_title" value="{{ $city->twitter_title}}" />
                                            </div>
                                            <div class="form-group">
                                                <strong class="form-label" for="twitter_meta_description">Description:</strong>
                                                <textarea class="form-control" id="twitter_meta_description" name="twitter_meta_description" rows="10">{{ $city->twitter_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control mt-2" id="json_ld_code" name="json_ld_code" rows="30">{{ $city->json_ld_code}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
