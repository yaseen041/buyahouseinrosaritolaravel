        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search_query" placeholder="Search by Name, Phone, Email, City or State" value="{{ old('search_query', $searchParams['search_query'] ?? '') }}">
                                    <span class="input-group-append">
                                        <button type="submit" class="btn btn-primary">Search</button>
                                        <a class="btn btn-danger ml-4" href="{{ url('admin/evaluations/') }}">
                                            Clear Search
                                        </a>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <p>Showing {{ $evals->firstItem() }} to {{ $evals->lastItem() }} of {{ $evals->total() }} entries</p>
                        </div>
                        <div class="col-md-3 text-right">
                            {{ $evals->links('pagination::bootstrap-4') }}
                        </div>
                    </div>
                </div>
            </div>
