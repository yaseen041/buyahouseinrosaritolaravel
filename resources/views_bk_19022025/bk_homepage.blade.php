                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-6 py-1 pr-30 pl-0">
                                                                    <div class="form-group categories">
                                                                        <select class="select single-select wide">
                                                                ...
                                                                <div class="col-lg-3 col-md-6 col-sm-12 py-1 pr-30 d-none d-lg-none d-xl-flex">
                                                                    <div class="checkboxes one-in-row margin-bottom-10 ch-{{ $index + 1 }}">
                                                                        <input id="check-{{ $index + 1 }}" type="checkbox" name="features[]" value="{{ $feature->slug }}">
                                                                        <label for="check-{{ $index + 1 }}">{{ $feature->title }}</label>
                                                                    </div>
                                                                </div>
                                                                @endforeach
                                                            </div>
